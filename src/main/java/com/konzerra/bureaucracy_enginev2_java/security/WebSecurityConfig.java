...
import com.konzerra.bureaucracy_enginev2_java.domain.auth.jwt.BearerTokenServerAuthenticationConverter;
...
public class WebSecurityConfig {
    ...
    private final String [] publicRoutes = {"/api/v1/auth/signin", "/api/v1/auth/signup"};
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        ...
        http.exceptionHandling(exceptionHandling ->{
            ...
            exceptionHandling.accessDeniedHandler((swe, e) -> {
